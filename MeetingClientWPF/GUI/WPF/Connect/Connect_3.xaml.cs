...
{
    /// <summary>
    /// Interaction logic for Connect_3.xaml
    /// </summary>
    public partial class Connect_3 : Page, INotifyPropertyChanged
    {
        ...
        public Connect_3(IMainWindowModel mainWindowModel)
        {
        ...
        public Connect_3() : this(new MainWindowModel())
        {
            InitializeComponent();
        }
